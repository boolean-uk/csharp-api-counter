...
{    
    return TypedResults.Ok(CounterHelper.Counters.FirstOrDefault(x => x.Id.Equals(id)));
});
...
{
    var counter = (Counter)CounterHelper.Counters.FirstOrDefault(x => x.Id.Equals(id));
    counter.Value++;
