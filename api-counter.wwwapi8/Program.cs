...
{
    var result = CounterHelper.Counters.Where(x => x.Id == id);
...
{
    var results = CounterHelper.Counters.Where(x => x.Value > number);
    return TypedResults.Ok(results);
});

////TODO:4. write another controlller method that returns counters that have a value less sthan the {number} passed in.
