...
namespace api_counter.wwwapi.Controllers
{
    ...
    public class CounterController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("IncrementIncrease/{id}")]

        public async Task<IResult> IncreaseIncrement(int id)
        {
            ...
            return TypedResults.Ok(counters.Where(x => x.Id == id));
        }
        ...
        [HttpGet]
        [Route("IncrementDecrease/{id}")]

        public async Task<IResult> DecreaseIncrement(int id)
        {
            foreach (var counter in counters)
            {
                if (counter.Id == id)
