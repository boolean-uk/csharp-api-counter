...
namespace api_counter.wwwapi.Controllers
{
    ...
    public class CounterController : ControllerBase
    {
        ...
        {
            Counter counter = counters.Where(c => c.Id == id).FirstOrDefault();
        ...
        public async Task<IResult> GetMoreThan(int number)
        {
            List<Counter> counter = counters.Where(c => c.Value > number).ToList();
            //leave return line the same
