...
namespace api_counter.wwwapi.Controllers
{
    ...
    public class CounterController : ControllerBase
    {
        ...
        public async Task<IResult> GetACounter(int id)
        {
            ...
            var counter = counters.First(c => c.Id == id);
        ...
        public async Task<IResult> GetGreaterThan(int num)
        {

            var itemsGreaterThan = counters.Where(c => c.Value > num);
        ...
        public async Task<IResult> GetLessThan(int num)
        {

            var itemsLessThan = counters.Where(c => c.Value < num);
        ...
        public async Task<IResult> IncreaseValue(int id)
        {
            ...
            var item = counters.First(c => c.Id == id);
            item.Value++;
