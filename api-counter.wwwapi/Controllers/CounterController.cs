...
namespace api_counter.wwwapi.Controllers
{
    ...
    public class CounterController : ControllerBase
    {
        ...
        public async Task<IResult> GetGreaterThanCounter(int number)
        {
        ...
        public async Task<IResult> GetLessThanCounter(int number)
        {
            var counter = counters.Where(x => x.Value < number);
        ...
        [HttpGet]
        [Route("increment/{id}")]
        public async Task<IResult> GetIncreasedCounter(int id)
        {
        ...
        [HttpGet]
        [Route("decrement/{id}")]
        public async Task<IResult> GetDecreasedCounter(int id)
        {
