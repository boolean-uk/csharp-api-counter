...
namespace api_counter.wwwapi.Controllers
{
    ...
    public class CounterController : ControllerBase
    {
        ...
        {
            var greaterCounter = counters.Where(i => i.Value > number).ToList();
            return Results.Ok(greaterCounter);
        }
        ...
        {
            var lessCounter = counters.Where(i => i.Value < number).ToList();
            return Results.Ok(lessCounter);
        }
